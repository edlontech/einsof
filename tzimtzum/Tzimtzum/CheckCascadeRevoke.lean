...
/-! # Task 7 — `cascade_revoke` preserves the bundle (one theorem per sub-bundle). -/
...
-- Manual VC, same family as `presC_cascade_revoke`: `revocation_clean` needs the newly-inactive
